...
RAG (Retrieval-Augmented Generation) powers a number of important applications in society. These include: 
...
RAG solves the following problems:

1. It provides the most important context for the large language model to take into consideration when
producing a response.
2. By retrieving useful information, it provides it a way to avoid hallucination as the required information
