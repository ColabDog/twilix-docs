...
## AI Services
"AI Services" is an unbrella term we use to encapsulate all the AI functionalities that Twilix offers out of the box. This includes semantic search, text summarization, data extraction, message suggestion, and generative Q&A.

## Vectorstore
The "vectorstore" refers to your Twilix vector database (if you're on the starter plan, your data will hosted be in a public, shared vector database instead). Your vectorstore is an important part of our API offerings because it allows us offer AI services custom to your data.

<Note>
  For most cases, you shouldn't use Twilix's vectorstore as your primary datasource/database. It's **highly recommended** that you use our vectorstore as a layer on top of your primary datasource. For example, you might have a postgresQL database, and in your application you can implement hooks to keep the data in your Twilix vectorstore in sync with changes. 
</Note>
...
<Tip>
Similar to collections, we recommend a one to one mapping from rows in your database to objects you're inserting.
</Tip>
...
<Tip>
You don't have to map every column in your database to fields in your vectorstore. Depending on your specific needs, you can leave out certain columns as you see fit, so that objects in your vectorstore are subsets of the rows in your database.
</Tip>

## Putting it all together
Here's a quick example of how collections, objects, and fields work together to form your vectorstore schema (don't worry if you don't understand how we're sending and storing data to your Twilix vectorstore, we will explain those in detail under the "Vectorstore" section).
...
Notice how your schema is automatically inferred based on the object you imported to your collection! 
